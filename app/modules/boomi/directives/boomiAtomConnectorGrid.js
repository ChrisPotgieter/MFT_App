/*
 /// <summary>
 /// app.modules.boomi.directives - boomiAtomConnectorGrid
 /// Directive to display a Boomi Atom Connector Grid
...
define(['modules/boomi/module', 'lodash','jszip'], function(module, lodash, jszip) {
    ...
    "use strict";
    window.JSZip = jszip;
    module.registerDirective('boomiAtomConnectorGrid', ['$state','uiSvc', function($state, uiSvc)
    {
        return {
            restrict: 'E',
            scope:{},
                        ...
                        [
                                {
                                    ...
                                    width: "200px",
                                    aggregates:["count"],
                                    footerTemplate:"No. of Connectors: #=count#",
                                },
                                {
                                    field: "version",
                                    title: "Version",

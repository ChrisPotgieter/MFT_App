/*
 /// <summary>
 /// app.modules.iib_v2.controllers - parameterIIBAppEditDialog
 /// Dialog Controller to Manage Edit of IIB Application Definition
 ///
...
define(['modules/iib_v2/module', 'lodash'], function (module, lodash) {
    ...
    module.registerController('parameterIIBAppEditDialogCtrl', ['$uibModalInstance', 'adminDataSvc', 'uiSvc', 'iibv2DataSvc', 'dialogData', function ($uibModalInstance, adminDataSvc, uiSvc, iibv2DataSvc, dialogData)
    {
        var _this = this;
        ...
        _this.stateInfo = {};
        _this.stateInfo.elementId = 'frmIIBAppConfigEdit';
        ...
        adminDataSvc.listFunctions.initializeDialogController(_this, $uibModalInstance, iibv2DataSvc.getTitle() + " Application");

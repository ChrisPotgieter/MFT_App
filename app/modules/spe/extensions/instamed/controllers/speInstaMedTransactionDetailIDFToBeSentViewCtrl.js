...
define(['modules/spe/module'], function (module) {
	...
	module.registerController('speInstaMedTransactionDetailIDFToBeSentViewCtrl', ['$scope', '$log', 'speInstamedDataSvc',function ($scope, $log, speInstamedDataSvc)
    {
        ...
        _this.functions.init = function()
        {
            ...
            var filter = {eftKey: $scope.vmDetailAbstract.model.balancingRecord.eftkey, processingStatus:'Inbound IDF'};

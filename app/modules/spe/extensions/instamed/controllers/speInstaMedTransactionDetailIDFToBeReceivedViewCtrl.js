...
define(['modules/spe/module'], function (module) {
	...
	module.registerController('speInstaMedTransactionDetailIDFToBeReceivedViewCtrl', ['$scope', '$log', 'speInstamedDataSvc',function ($scope, $log, speInstamedDataSvc)
    {
        ...
        _this.functions.init = function()
        {
            ...
            var filter = {eftKey: $scope.vmDetailAbstract.model.balancingRecord.eftkey, processingStatus:'X12 999' };
            filter.topCount = 300;

/*
 /// <summary>
 /// app.modules.spe.extension.instamed.controllers - speInstaMedTransactionDrillPartnerDialogCtrl
 /// SPE InstaMed Extension
 /// Controller to manage Drill of a Given Partner Record (ldf)
 ///
...
define(['modules/spe/module'], function (module) {
	...
	module.registerController('speInstaMedTransactionDrillPartnerDialogCtrl', ['$uibModalInstance', '$scope', '$log', 'speInstamedDataSvc','dialogData', function ($uibModalInstance, $scope, $log, speInstamedDataSvc, dialogData)
    {
        ...
        _this.functions.init = function()
        {
            ...
            var title = speInstamedDataSvc.getProcTitles().partner;

...
/*
 /// <summary>
 /// modules.common.directives.input - mqaJqSmallDateRatePicker.js
 /// Directive to Manage Small Date Range Selection used in Dashboards via Jquery Date Selectors
 ///
...
define(['modules/common/module', 'lodash', 'moment'], function(module, lodash, moment){
    ...
    module.registerDirective('mqaJqSmallDateRangePicker', ['$timeout', 'uiSvc', function($timeout, uiSvc)  {
    return {
        restrict: 'E',
        replace: true,
        templateUrl: 'app/modules/common/directives/input/mqaJqSmallDateRangePicker.tpl.html',
        scope:{},
        bindToController: {
            options:"=",
            validator:'=',
        },
        controllerAs:'vmSmallDateRange',
        controller: function ($scope, $element)
        {
            var _this = this;
            // setup the variables
            _this.functions = {};
            _this.model = {fromDate: {value: null, options: {}}, toDate: {value: null, options: {}}, disabled: false};
            ...
            // watch the options
            $scope.$watch("vmSmallDateRange.options", function(newValue, oldValue)
            {
            ...
            _this.functions.setupBV = function ()
            {
                ...
                var formOptions = lodash.merge({}, fields, uiSvc.getFormNoFeedbackIcons());

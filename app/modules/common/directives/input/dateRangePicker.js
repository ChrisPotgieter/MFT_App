/*
 /// <summary>
 /// modules.common.directives.input - dateRangePicker.js
 /// Date Range Picker as adapted from Project https://github.com/fragaria/angular-daterangepicker
 /// Used as part of the date Picker License
 /// This will be eventually replaced by a true angular directive using angular bootstrap UI as I don't like this one
 /// but I don't have time to write a new one just yet
...
define(['modules/common/module','moment','bootstrap-daterange-picker'], function(module, moment){
  "use strict";
  moment().format();

  module.registerValue('dateRangePickerConfig',
      {
        timePicker: true,
        ...
        ranges: {
            ...
            'Current Week': [moment().startOf('week').set({hour: 0, minute:0, second: 0}), moment().endOf('week')],
            'Current Month': [moment().startOf('month').set({hour: 0, minute:0, second: 0}), moment().endOf('month')]
        }
      });

  module.registerDirective('dateRangePicker', ['$compile', '$timeout', '$parse', 'dateRangePickerConfig', function($compile, $timeout, $parse, dateRangePickerConfig){
      return {
          require: 'ngModel',
          restrict: 'A',
          scope: {
